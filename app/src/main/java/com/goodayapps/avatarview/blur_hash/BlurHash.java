...
import static com.goodayapps.avatarview.blur_hash.BlurHashUtils.getBitmapPixels;
import static com.goodayapps.avatarview.blur_hash.BlurHashUtils.linearTosRGB;
import static com.goodayapps.avatarview.blur_hash.BlurHashUtils.max;
import static com.goodayapps.avatarview.blur_hash.BlurHashUtils.sRGBToLinear;
import static com.goodayapps.avatarview.blur_hash.BlurHashUtils.signPow;
...
public final class BlurHash {
     ...
     * @return the blur hash
     */
    public static String encode(@NonNull Bitmap bitmap, int componentX, int componentY) {
        int width = bitmap.getWidth();
        int height = bitmap.getHeight();
        int[] pixels = getBitmapPixels(bitmap, 0, 0, width, height);
